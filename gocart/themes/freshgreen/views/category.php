<?php include('header.php'); ?>
	...
	<div class="row">
		...
		<div class="span3 goods-item goods-menu">
			<div class="bd">
                	<dl>
                    	<dt><?php echo $page_title; ?></dt>
                    	<?php foreach($subcategories as $subcategory):?>
                       	<dd><a href="<?php echo site_url(implode('/', $base_url).'/'.$subcategory->slug); ?>"><?php echo $subcategory->name;?></a></dd>
                       	<?php endforeach;?>
                    </dl>
             </div>
		</div>
