...
<body>
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container"
				style="margin-top: -10px; padding: 0px; height: auto;">
				<div class="row">
					<div class="span3">
						<a style="margin-top: 15px;" href="<?php echo site_url();?>"
							data-section="body" class="brand scroller"> <img alt="GoCart"
							src="http://gocartdv.com/gocart/themes/gocart/assets/img/logo.png">
						</a>
					</div>
					<div class="span9">
						<div class="row">
							<div class="span9">
								<div class="cart-nav">
									<ul style="margin: 0px; top: 0px;" class="nav pull-right">
						        ...
						        <?php endif; ?>
                                        <li><a
											href="<?php echo site_url('cart/view_cart');?>"> <i
						...
						<div class="row">
							<div class="span9">
								...
								<div class="nav-collapse collapse" style="height: 0px;">
									<ul
										style="margin-top: -6px; padding-bottom: 6px; margin-right: -15px;"
										class="nav pull-right">
										<li class="dropdown"><a data-toggle="dropdown"
											class="dropdown-toggle" href="#"> <?php echo lang('catalog');?> <b
												class="caret"></b>
										</a>
											<ul class="dropdown-menu">
