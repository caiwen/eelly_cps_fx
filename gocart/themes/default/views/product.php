		...
		<div class="row">
			<div class="span8">
				<div class="product-cart-form">
					...
					<div class="control-group">
						<div class="controls">
						        <span class="button-wrap"><a onclick="addFavorite();" class="button button-pill button-primary" href="javascript:void(0);">加入收藏</a></span>
								<span id="goumai" class="button-wrap"> <a role="button" class="button button-pill button-highlight button-primary" rel="nofollow" href="<?php echo $product->click_url;?>">去衣联购买</a></span>
						</div>
					</div>
