...
$lang['yes']					= '是';
$lang['no']						= '否';
$lang['download_link']			= '点击这里访问您的下载！';
$lang['catalog']				= '商品类目';
$lang['account']				= '账户';
$lang['close']					= '关闭';

$lang['empty_cart']				= '你的购物车是空的';
$lang['single_item']			= '你的购物车有 %d 件商品';
$lang['multiple_items']			= '你的购物车有 %d 件商品';
$lang['empty_view_cart']		= '购物车没有商品';
$lang['your_cart']				= '购物车';

$lang['on_sale']				= '优惠！';
$lang['related_products_title']	= '您可能还会喜欢...';
$lang['form_submit']			= '提交';
$lang['form_register']			= '注册';
$lang['form_login']				= '登录';
$lang['reset_password']			= '重置密码';
$lang['form_search']			= '搜索';
$lang['form_cancel']			= '取消';
$lang['form_add_to_cart']		= '加入购物车';
$lang['form_update_cart']		= '更新购物车';
$lang['form_checkout']			= '结算';
$lang['form_continue']			= '继续购物';
$lang['form_choose']			= '选择';
$lang['form_edit']				= '编辑';
$lang['form_delete']			= '删除';
$lang['form_search']			= '查找';
...
$lang['step_1']					= '第一步';
$lang['step_2']					= '第二步';
$lang['free_shipping_basic']	= '免邮';

$lang['search']					= '搜索';
$lang['search_error']			= '你没有提供一个搜索词！';
$lang['amount']					= '数量';
$lang['custom_amount']			= '自定义数量';
$lang['preset_amount']			= '预置数量';
$lang['recipient_name']			= '收件人姓名';
$lang['recipient_email']		= '收件人邮箱';
$lang['sender_email']			= '发件人邮箱';
$lang['custom_greeting']		= '自定义问候语';
$lang['check_out']				= '结算';

$lang['sort_by_name_asc']		= 'A到Z排序';
$lang['sort_by_name_desc']		= 'Z到A排序';
$lang['sort_by_price_asc']		= '价格从低到高';
$lang['sort_by_price_desc']		= '价格从高到低';

$lang['products']				= '产品';
$lang['out_of_stock']			= '缺货';
$lang['no_products']			= '目前此类别中没有可用的产品。';
$lang['no_image_available']		= '没有图片';
$lang['product_reg']			= '原价:';
$lang['product_price']			= 'Price:';
$lang['product_sale']			= '售价:';
$lang['available_options']		= '可用的选项';
$lang['choose_option']			= '选择选项';
$lang['tab_description']		= '描述';
$lang['tab_related_products']	= '相关产品';
$lang['subcategories']			= '子分类';

$lang['loading']					= '载入中...';
$lang['coupon_label']				= '如果你有一个优惠券，请在此处输入验证码：';
$lang['gift_card_label']			= '如果你有一张礼品券，在此输入验证码：';
$lang['apply_gift_card']			= '申请礼品卡';
$lang['apply_coupon']				= '申请优惠券';
$lang['customer_information']		= '用户信息';
$lang['error_save_payment']			= 'There was a problem saving your payment method';
$lang['error_choose_payment']		= '请选择支付方式';
$lang['error_choose_shipping']		= '请选择配送方式';
$lang['continue_shopping']			= '继续购物';
$lang['register_now']				= '马上注册';
$lang['submit_order']				= '提交订单';
$lang['edit_customer_information']	= '编辑用户信息';
$lang['communication_error']		= '有一个意想不到的问题与服务器通信。';
$lang['no_payment_needed']			= '有没有必要付款。';
$lang['choose_payment_method']		= '选择支付方式';
...
$lang['payment_method']				= '支付信息';
$lang['submit_payment_method']		= '提交支付方式';
$lang['product_information']		= '产品信息';
$lang['price_and_quantity']			= '价格 &amp; 数量';
$lang['sku']						= 'SKU';
$lang['name']						= '名字';
$lang['price']						= '价格';
$lang['description']				= '描述';
$lang['quantity']					= '数量';
$lang['totals']						= '总量';
$lang['group_discount']				= '团体优惠';
$lang['subtotal']					= '小计';
$lang['cart_total']					= '总和';
$lang['coupon_discount']			= '优惠券折扣';
$lang['gift_card_discount']			= '礼品卡折扣';
$lang['discounted_subtotal']		= '折扣总计';
$lang['shipping']					= '配送';
$lang['tax']						= '税收';
$lang['taxes']						= '税收';
$lang['grand_total']				= '累计';
$lang['address_manager']			= '地址管理';
$lang['address_form']				= '地址列表';
$lang['your_addresses']				= '你的收获地址';
$lang['address_button']				= '更换收获地址';
$lang['shipping_address_button']	= '更改送货地址';
$lang['billing_address_button']		= '更改帐单地址';
$lang['shipping_method_button']		= '更换配送方式';
$lang['billing_method_button']		= '更换结算方式';
$lang['shipping_and_billing']		= '送货及账单信息';
$lang['billing_address']			= '帐单地址';
$lang['choose_billing_address']		= '选择您的帐单地址';
$lang['use_address_for_shipping']	= '使用此地址的运费';
$lang['shipping_address']			= '送货地址';
$lang['shipping_information']		= '送货信息';
$lang['billing_information']		= '账单信息';
$lang['choose_shipping_address']	= '选择您的送货地址';
$lang['choose_address']				= '选择地址';
$lang['ship_to_address']			= '配送到这个地址';
$lang['contact_info']				= '联系方式';
$lang['address_company']			= '公司';
$lang['address']					= '地址';
$lang['address1']					= '地址1';
$lang['address2']					= '地址2';
$lang['address_firstname']			= '名';
$lang['address_lastname']			= '姓';
$lang['address_email']				= '邮箱';
$lang['address_phone']				= '手机';
$lang['address_city']				= '城市';
$lang['address_postcode']			= 'Zip';
$lang['address_country']			= '国家';
$lang['address_state']				= 'State';
$lang['message_address_saved']		= '你的地址已保存';

$lang['default']					= '默认';
$lang['additional_order_details']	= '额外的订单详细信息';
$lang['additional_details']			= '其他详细信息';
$lang['heard_about']				= '你是怎么知道我们的？';
$lang['shipping_instructions']		= '送货说明';
