...
<div style="text-align:right">
    <a class="btn" href="<?php echo site_url($this->config->item('admin_folder').'/categories/sync_eelly_cate'); ?>"><i class="icon-download"></i> <?php echo lang('sync_eelly_category');?></a>
