...
<title>衣联联盟分销系统<?php echo (isset($page_title))?' :: '.$page_title:''; ?></title>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/cart-base.js');?>"></script>
...
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container">
			...
			<a class="brand" href="<?php echo $admin_url;?>">Ecps</a>
				...
				<ul class="nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<?php echo $admin_url;?>theme"><?php echo lang('common_themes') ?></a></li>
						</ul>
					</li>
					<?php endif; ?>
				</ul>
