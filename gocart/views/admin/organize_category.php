...
<div style="text-align:right">
    <a class="btn" target="_blank" href="<?php echo  site_url($this->config->item('admin_folder').'/categories/sync_eelly_goods/'.$category->id);?>"><i class="icon-download"></i>同步该分类下的衣联商品</a>
</div>
