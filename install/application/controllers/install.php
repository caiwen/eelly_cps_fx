...
class Install extends CI_Controller {
	...
	public function index()
	{
		...
		*/
		...
		$this->load->helper(array('form', 'file','language'));
		$this->lang->load('install');
		
		$this->form_validation->set_rules('hostname', lang('hostname'), 'required');
		$this->form_validation->set_rules('database', lang('database_name'), 'required');
		$this->form_validation->set_rules('username', lang('username'), 'required');
		$this->form_validation->set_rules('password', lang('password'), 'trim');
		$this->form_validation->set_rules('prefix', lang('databse_prefix'), 'trim');
		
		$this->form_validation->set_rules('admin_email', lang('admin_email'), 'required|valid_email');
		...
		$this->form_validation->set_rules('webmaster_id', lang('webmaster_id'), 'required|trim');
